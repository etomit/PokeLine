...
<section class="arena-wrap">
    ...
    @endif
    <div id="battle-app" class="battle-app {{ $kind === 'online' && $battle->status === 'waiting' ? 'is-waiting' : '' }}"
         data-kind="{{ $kind }}"
        ...
        <div class="battle-toolbar"><span id="turn-label">{{ __('ui.turn') }} 1</span><button id="sound-toggle" type="button">🔊 {{ __('ui.sound') }}</button></div>
